...
const man = require('../json/man.json')
const women = require('../json/women.json')
const publish = require('../json/publish.json')
const admission = require('../json/admission.json')
const adMan = require('../json/admissionMan.json')
const adGirl = require('../json/admissionGirl.json')

const heavyMan = require('../json/more/heavyMan.json')
const heavyGirl = require('../json/more/heavyGirl.json')
const editor = require('../json/more/editor.json')
const newBook = require('../json/more/newBook.json')
const classic = require('../json/more/classic.json')

const rankingMan = require('../json/rankingMan.json')
const rankingGirl = require('../json/rankingGirl.json')
const rankingClassic = require('../json/rankingClassic.json')
